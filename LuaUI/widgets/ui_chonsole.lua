...
VFS.Include("luaui/config/globals.lua", nil, VFS.DEF_MODE)
...
function widget:Initialize()
	...
	Chili = WG.Chili
	if nil== Chili or nil == Chili.Screen0 then
		Spring.Echo("Chili not loaded")
		widgetHandler:RemoveWidget(widget)
	end
	...
	if not CHONSOLE_FOLDER then CHONSOLE_FOLDER= "luaui/chonsole" end
