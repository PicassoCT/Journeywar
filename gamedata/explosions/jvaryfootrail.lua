...
return {
  ["jvaryfootrail"] = {
    ...
    bitmapmuzzleflame = {
          ...
          water              = true,
          properties = {
            colormap           = [[  0.2 0.2 0.2 1  0.2 0.2 0.2 0.8  0.2 0.2 0.2 0.8 ]],
            dir                = [[dir]],
            frontoffset        = 10,
          ...
          water              = true,
          properties = {
            colormap           = [[  0.2 0.2 0.2 1 0.2 0.2 0.2 1  0.2 0.2 0.2 1]],
            dir                = [[dir]],
            frontoffset        = 0,
            fronttexture       = [[smokeSmall]],--redexplo
            length             = 25,
      ...
      water              = true,
      properties = {
        colormap           = [[0.8 0.1 0.8 0.01  	0.75 0.2 0.75 0.01 	0.7 0.3 0.7 0.01   0.7 0.3 0.7 0.01 	]],
        dir                = [[dir]],
        frontoffset        = 0,
        fronttexture       = [[empty]],
        length             = -82,
