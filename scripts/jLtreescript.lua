...
FixFunctionTabel[5] = function()
    ...
    for i = 2, relativeIndex, 1 do
        PrevPosTable[i] = {
            x = PrevPosTable[i - 1].x + math.random(-1 * quarterheight, quarterheight),
...
gramarTable = {
    ...
    [8] = {
        --a start starshaped spreading gramar
        name = "Test X_Axis",
        ...
        transitions = {
            ["A"] = function(olddeg, degree, Tpiece, Epiece, recIt, boolLastLevel)
