...
------------------------------------------------------------------------------------
 ...
 --basically its the arcus sin of Alpha divided through the squareroot of (bฒ + aฒ)
 local AlphaX= math.asin(((DistanceX/(math.sqrt(DistanceX*DistanceX + lengthOfRopeInX*lengthOfRopeInX))))) 

				--งๆ@งๆ@งๆ@งๆ@งๆ@งๆ@งๆ@งๆ@งๆ@งๆ@งๆ@งๆ@งๆ@งๆ@งๆ@งๆ@งๆ@งๆ@งๆ@งๆ@งๆ@งๆ@งๆ@งๆ@งๆ@งๆ@งๆ@งๆ@งๆ@งๆ@งๆ@งๆ@งๆ@งๆ@งๆ@งๆ@งๆ@งๆ@งๆ@งๆ@
...
-- Echo Block for debugging purposes
 ...
 --give Out All the Values ever used in this function
  ----Spring.Echo("|moveSpeedZ",moveSpeedZ)
 ----Spring.Echo("|alphaOfOldZ",alphaOfOldZ)
 ----Spring.Echo("1alphaOfOldX",alphaOfOldX)
 -- --Spring.Echo(moveSpeedX)			
 ----Spring.Echo("3alphaInDegree",alphaXInDegree,"		|alphaZInDegree",alphaZInDegree)
 ----Spring.Echo("4DistanceZ",DistanceZ,"				|zDistanceOfOld",zDistanceOfOld)
 ----Spring.Echo("5DistanceX",DistanceX			)
 ----Spring.Echo("6lengthOfRopeInX",lengthOfRopeInX,"	|xDistanceOfOld",xDistanceOfOld)
 ----Spring.Echo("7NumberOfElements",numberOfElements,"	|xDistanceOfOld",xDistanceOfOld)
 ----Spring.Echo(		"zDistanceOfOld",zDistanceOfOld)
...
boolRopeRelease=false
	...
	if not countStartDependBuildProgress then 	ropeDrop()	break	end
									...
									repeat 	
										...
										lmoveThatTrooper(changeX,changeZ,speedyGonzo,buildProgress)	
									...
									-----------------------------------------------------------
										...
										buildProgress=updateBuildProgress()
										moveThatTrooper(changeX,changeZ,speedyGonzo,buildProgress)
