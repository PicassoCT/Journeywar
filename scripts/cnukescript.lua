...
local spGetUnitPosition=Spring.GetUnitPosition
	if proChoice ~= nil then
											...
											--I survived it, i was standing right in the nuke, and i survived it, wait what is this function.. oh shit
...
-- function orangeCloudTest(x)
-- for i=1,x,1 do
-- EmitSfx(centcolumnFxEmit1,1034)
-- Sleep(50)
-- end
...
Spring.DestroyUnit(unitID,true,false)
	...
	--[[	 	
		for i=1,(45000), 1 do
		Sleep(12)
		EmitSfx(ringCenter,1030)
		Sleep(12)
		EmitSfx(ringCenter,1030)
		end 
		--]]

		--Spring.Echo("Explosion Restarted")
		--end
	end
