...
SIG_WARP= 128
	...
	while true do
		...
		Move(strider,y_axis,-13,0.5)
		Turn(striderlegA,z_axis,math.rad(40-5),0.1)
		Turn(striderlegB,z_axis,math.rad(-40+10),0.3)
		Turn(striderlegA2,z_axis,math.rad(-45+5),0.1)
		Turn(striderlegB2,z_axis,math.rad(48-10),0.2)
		Turn(striderlegA3,x_axis,math.rad(35+5),0.1)
		Turn(striderlegB3,x_axis,math.rad(-45-5),0.3)
