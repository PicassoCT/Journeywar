...
function SetUnitIKPieceLimits(self)
...
boolStartPiece, _=checkPiece(unitID,startPiece)
boolEndPiece, PiecList=checkPiece(unitID,endPiece)
if not boolStartPieceValid or not boolEndPieceValid then return nil, false end
--forge IK-Chain

local ikChain={
boolAktive=true,
vSpeed=makeVector(0,0,0),
pieceChain={}           ,
jacobiMatrice={}        ,
}
