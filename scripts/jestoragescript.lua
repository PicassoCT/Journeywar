...
Turn(feetFetish[nr][1],z_axis,math.rad(19),0.7)
Turn(feetFetish[nr][3],z_axis,math.rad(9),0.7)

end

function TurnF(nr,deg,boolWait)
Turn(feetFetish[nr][1],y_axis,math.rad(deg),0.1)
...
Turn(feetFetish[nr][1],x_axis,math.rad(0),1.7)
Turn(feetFetish[nr][3],z_axis,math.rad(0),1.7)
	if boolWait== nil or boolWait==true then
	WaitForTurn(feetFetish[nr][1],z_axis)
...
comonSpeed=0.2
Turn(center,y_axis,math.rad(45),25)

	while(true) do
	StartThread(forwardFeet)
	StartThread(backFeet)
		while(boolBackFeetDone==false or boolFrontFeetDone==false ) do
		Sleep(210)	
		end
...
local boolBackFeetDone=false
local boolFrontFeetDone=false

function forwardFeet()

boolFrontFeetDone=false
	TurnF(2,0,true)
	TurnF(3,0,true)
	lowerFeet(3,false)
	lowerFeet(2,true)
	...
	liftFeet(3)
	Sleep(500)
	boolFrontFeetDone=true
end

function backFeet()

boolBackFeetDone=false
	TurnF(4,-40,false)
	TurnF(1,40,true)
	liftFeet(1)
	liftFeet(4)
...
function legs_down()
Turn(center,y_axis,math.rad(0),25)
