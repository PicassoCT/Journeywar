...
function forTheBlinkOfAnEye()
	...
	-- showT(snakeTable, 1, math.random(2,10))
	-- showT(snakeTable, 11, math.random(11,20))
	-- Sleep(750)
	-- for i=10,1 do
		-- Hide(snakeTable[i])
		-- Hide(snakeTable[math.min(20,30-i)])
		-- Sleep(500)
	-- end
...
function keepAboveGround()
	...
	while true do
		...
		boolNewOverground= (math.abs((py +9000 -gh)-9000) > 50)
		...
		lastDeg[i].deg_= math.max(0, math.min(45,lastDeg[i].deg_ + lastDeg[i].changeRate/(#snakeTable-i)))
