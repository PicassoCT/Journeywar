...
function daVinciAmok(frame)
    ...
    if MissionFunctionTable[2][3] == -1 then
        ...
        if MissionFunctionTable[2][10] == nil then
            ...
            return true
        end --only Journeys.. what sort of shit is this?
    ...
    else cout("Mission failed1") return true
    end
    ...
    else cout("Mission failed2") return true
    end
    ...
    else cout("Mission failed3") return true
    end
    ...
    else cout("Mission failed4") return true
    end
    ...
    else cout("Mission failed5") return true
    end
    ...
    else cout("Mission failed6") return true
    end
    ...
    else cout("Mission failed7") return true
    end
    ...
    else cout("Mission failed8") return true
    end
    ...
    else cout("Mission failed10") return true
    end
    ...
    else cout("Mission failed11") return true
    end
    ...
    else cout("Mission failed12") return true
    end
    ...
    if MissionFunctionTable[2][3] == 13 then
        ...
        if teamID then
            ...
            for _ = 1, 4, 1 do
                ...
                rx, ry, rz = math.random(-100, 100), 0, math.random(-100, 100)
                GG.UnitsToSpawn:PushCreateUnit("jskinfantry", x + rx, y + ry, z + rz, 1, teamID)
