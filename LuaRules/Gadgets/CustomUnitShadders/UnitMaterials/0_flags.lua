...
local function UnitCreated(unitID, material, materialID)
  ...
  local biopieces = {"eggStage3", "eggStage2", "eggStage1", "eggswim","eggstage1", "eggstage2", "eggstage3a", "eggstage3b", "dotter1", "dotter2", "dotter3", "dotter4","dotter5", "bean1", "bean2", "bea3", "fungi3",	"fungi2","fungi4", "lavaPyre", "lavaCircle"}

  for i=1,#biopieces do
    local pieceID = pieceMap[ biopieces[i] ]
    if (pieceID) then
      local dl = pieceDLs[i]
      if (not dl) then
